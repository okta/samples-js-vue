  ...
  <div class="messages">
    ...
    <div v-if="messages.length">
      <p>This component makes a GET request to the resource server example, which must be running at
        <code>localhost:8080/api/messages</code>
      </p>
      ...
      <p>This route is protected with the
        <code>onAuthRequired</code> navigation guard, which will ensure that this page cannot be accessed until you have authenticated and have an access token
        in local storage.</p>
